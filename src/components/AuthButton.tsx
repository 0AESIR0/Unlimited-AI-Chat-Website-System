...
export function AuthButton() {
  ...
  if (status === 'loading') {
    return (
      <div className="h-9 w-24 bg-gray-200 dark:bg-gray-700 animate-pulse rounded-full"></div>
    )
  }
    ...
    return (
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        >
          ...
          <span className="sm:hidden">{t('header.signOutShort')}</span>
        </button>
      </div>
    )
  }
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-semibold text-white bg-green-600 hover:bg-green-700 border border-transparent rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
    >
